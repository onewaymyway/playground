///////////////////////////////////////////////////////////
//  SHA256Tool.as
//  Macromedia ActionScript Implementation of the Class SHA256Tool
//  Created on:      2018-5-14 下午6:00:11
//  Original author: ww
///////////////////////////////////////////////////////////
...
package wraps
{
	 ...
	 * @version 1.0
	 * 
	 * @created  2018-5-14 下午6:00:11
	 */
	public class SHA256Tool
	{
		public static const K:Array=[0x428a2f98, 0x71374491, 0xb5c0fbcf, 0xe9b5dba5, 0x3956c25b, 
		...
		public function SHA256Tool()
		{
		}
		public static function setArray(target:*, source:Array):void {
		...
		public static function digest(message:*):* {
			...
			var words = __JS__("new Int32Array(wordLength);")
			var byteIndex = 0;
			...
			var w = __JS__("new Int32Array(64);")
		...
		public static function hash(message:*):String {
			var digest:Array = SHA256Tool.digest(message);
			var hex:String = '';
			for (var i:int = 0; i < digest.length; i++) {
				var s:String = '0' + digest[i].toString(16);
