...
(function(window,document,Laya){
	...
	*/
	...
	var Game=(function(){
		...
		__proto.saveView=function(view){
			var childs;
			childs=view._childs;
			var i=0,len=0;
			len=childs.length;
		...
		__proto.initGameView=function(){
			...
			this.resSp=ScriptUICreateUtils.createSpForRender();
			this.resSp.pos(100,100);
			Laya.stage.addChild(this.resSp);
		}

		__proto.onMouseClick=function(){
			this.saveView(this.resSp);
		}
	...
	*@author ww
	*/
	//class scriptuis.ScriptUICreateUtils
	var ScriptUICreateUtils=(function(){
		function ScriptUICreateUtils(){}
		__class(ScriptUICreateUtils,'scriptuis.ScriptUICreateUtils');
		ScriptUICreateUtils.initPolys=function(){
			ScriptUICreateUtils.noUpPoly=[
			0,0,
			100,0,
			100,40,
			10+20,40,
			...
			10,40,
			0,40];
			ScriptUICreateUtils.normalPoly=[
			0,0,
			10,0,
			10+20*0.5,10,
			10+20,0,
			...
			10,40,
			0,40];
			ScriptUICreateUtils.noAnglePoly=[
			0,0,
			100,0,
			100,40,
			0,40];
			ScriptUICreateUtils.sideBarPoly=[
			0,0,
			10,0,
			10+20 *0.5,10,
			10+20 *0.5,40,
			0,40,];
			ScriptUICreateUtils.multilineStartPoly=[
			0,10,
			20*0.5,0,
			100,0,
			100,40,
			...
			10,40,
			0,40];
			ScriptUICreateUtils.logicPoly=ScriptUICreateUtils.createLogicPoly(100,22,15);
		}

		ScriptUICreateUtils.createLogicPoly=function(width,height,sideLen){
			var rst;
			rst=[
			0,height *0.5,
			sideLen,0,
		...
		ScriptUICreateUtils.createTriangle=function(width,height){
			var rst;
			rst=[
			0,0,
			width,0,
		...
		ScriptUICreateUtils.createComboxSprite=function(name,width,height,arrowWidth,arrowHeight,arrowRight){
			(width===void 0)&& (width=40);
			(height===void 0)&& (height=26);
			(arrowWidth===void 0)&& (arrowWidth=14);
			(arrowHeight===void 0)&& (arrowHeight=12);
			(arrowRight===void 0)&& (arrowRight=10);
			var radius=0;
			radius=5;
			var sp;
			sp=ScriptUICreateUtils.createRoundCornerRec(name,width-radius,height,radius,"#ffffff","#000000",1);
			var triangleSp;
			triangleSp=ScriptUICreateUtils.createNormalSprite("",ScriptUICreateUtils.createTriangle(arrowWidth,arrowHeight),"#000000","#000000",0);
		...
		ScriptUICreateUtils.createNormalSprite=function(name,points,fillColor,lineColor,lineWidth){
		...
		ScriptUICreateUtils.createSpsByColor=function(spList,fillColor,lineColor,lineWidth){
			(lineWidth===void 0)&& (lineWidth=1);
			var i=0,len=0;
			len=ScriptUICreateUtils.defines.length;
			for (i=0;i < len;i++){
				/*no*/this.tDis=ScriptUICreateUtils.defines[i];
				/*no*/this.tSp=ScriptUICreateUtils.createNormalSprite(/*no*/this.tDis[0],/*no*/this.tDis[1],/*no*/this.tDis[3]||fillColor,lineColor,/*no*/this.tDis[2]);
				spList.push(/*no*/this.tSp);
			}
		}

		ScriptUICreateUtils.createRoundCornerRec=function(name,width,height,radius,fillColor,lineColor,lineWidth){
			(name===void 0)&& (name="");
			(width===void 0)&& (width=80);
		...
		ScriptUICreateUtils.createSpForRender=function(){
			var sp;
			sp=new Sprite();
			ScriptUICreateUtils.defines=[];
			ScriptUICreateUtils.defines.push(["script_bgud.png",ScriptUICreateUtils.normalPoly,1]);
			ScriptUICreateUtils.defines.push(["script_bgd.png",ScriptUICreateUtils.noUpPoly,1]);
			ScriptUICreateUtils.defines.push(["script_bgevent.png",ScriptUICreateUtils.noUpPoly,1,"#608fee"]);
			ScriptUICreateUtils.defines.push(["script_bg.png",ScriptUICreateUtils.noAnglePoly,1]);
			ScriptUICreateUtils.defines.push(["script_bglogic.png",ScriptUICreateUtils.logicPoly,1,"#fbba9d"]);
			ScriptUICreateUtils.defines.push(["script_sidebar.png",ScriptUICreateUtils.sideBarPoly,0,"#68cdff"]);
			ScriptUICreateUtils.defines.push(["script_multistart.png",ScriptUICreateUtils.multilineStartPoly,0,"#68cdff"]);
			ScriptUICreateUtils.defines.push(["script_multimid.png",ScriptUICreateUtils.normalPoly,0,"#68cdff"]);
			ScriptUICreateUtils.defines.push(["script_multiend.png",ScriptUICreateUtils.noUpPoly,0,"#68cdff"]);
			var spList;
			spList=[];
			var tDis;
			var i=0,len=0;
			...
			lineColor="#cccccc";
			lineWidth=1;
			ScriptUICreateUtils.createSpsByColor(spList,fillColor,lineColor);
			spList.push(ScriptUICreateUtils.createRoundCornerRec("script_valuebg",80-10 *2,30,10,"#fbc2c2","#ffffff",1));
		...
		ScriptUICreateUtils.ImgHeight=40;
		ScriptUICreateUtils.AngleDepth=10;
		ScriptUICreateUtils.AngleWidth=20;
		ScriptUICreateUtils.AngleStart=10;
		ScriptUICreateUtils.ImgWidth=100;
		ScriptUICreateUtils.SideBarWidth=10;
		ScriptUICreateUtils.logicSideLen=15;
		ScriptUICreateUtils.normalPoly=null
		ScriptUICreateUtils.noUpPoly=null
		ScriptUICreateUtils.noAnglePoly=null
		ScriptUICreateUtils.sideBarPoly=null
		ScriptUICreateUtils.multilineStartPoly=null
		ScriptUICreateUtils.logicPoly=null
		ScriptUICreateUtils.defines=null
		ScriptUICreateUtils.__init$=function(){
			;
			ScriptUICreateUtils.initPolys();;
		}

		return ScriptUICreateUtils;
	})()
	...
	*@author ww
	*/
	//class scriptuis.UICreateUtils
	var UICreateUtils=(function(){
		function UICreateUtils(){}
		__class(UICreateUtils,'scriptuis.UICreateUtils');
		UICreateUtils.createHeadIcon=function(name,width,color){
			(width===void 0)&& (width=50);
	...
	*@author ww
	*/
	//class wraps.filesaver.FileSaver
	var FileSaver=(function(){
		function FileSaver(){}
		__class(FileSaver,'wraps.filesaver.FileSaver');
		FileSaver.dataURLtoBlob=function(dataurl){
		...
		FileSaver.saveSprite=function(view,name){
			...
			console.log("ba:",ba);
			wraps.filesaver.FileSaver.saveCanvas(name,pic);
		}
	...
	*/
	...
	//class ui.codeeditor.CodeIconsUI extends laya.ui.View
	var CodeIconsUI=(function(_super){
		function CodeIconsUI(){CodeIconsUI.__super.call(this);;
		};

		__class(CodeIconsUI,'ui.codeeditor.CodeIconsUI',_super);
		var __proto=CodeIconsUI.prototype;
		__proto.createChildren=function(){
			laya.ui.Component.prototype.createChildren.call(this);
			this.createView(CodeIconsUI.uiView);
		}

		CodeIconsUI.uiView={"type":"View","props":{"width":720,"height":1280},"child":[{"type":"Sprite","props":{"y":13,"x":7,"width":103,"name":"bg01.png","height":50},"child":[{"type":"Poly","props":{"y":1,"x":1,"points":"0,0,20,0,30,9,40,0,100,0,100,40,40,40,30,47,20,40,0,40","lineWidth":1,"lineColor":"#ff0000","fillColor":"#00ffff"}}]}]};
		return CodeIconsUI;
	})(View)
	...
	*/
	...
	Laya.__init([LoaderManager,EventDispatcher,Render,Browser,View,Timer,GraphicAnimation,LocalStorage,ScriptUICreateUtils]);
	new Game();
