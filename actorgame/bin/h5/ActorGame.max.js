...
(function(window,document,Laya){
	...
	*@author ww
	*/
	//class scenetools.SceneSwitcher
	var SceneSwitcher=(function(){
		function SceneSwitcher(){
			this.container=null;
			this.init();
		}

		__class(SceneSwitcher,'scenetools.SceneSwitcher');
		var __proto=SceneSwitcher.prototype;
		__proto.init=function(){
			this.container=new Box();
			this.container.left=this.container.right=this.container.top=this.container.bottom=0;
			Laya.stage.addChild(this.container);
		}

		__proto.getItem=function(clz,isInstance){
			var sp;
			if (!isInstance){
				sp=new clz();
				}else{
		...
		__proto.showDialog=function(clz,param,closeOthers,isInstance){
			(closeOthers===void 0)&& (closeOthers=true);
			(isInstance===void 0)&& (isInstance=true);
			var sp;
			sp=this.getItem(clz,isInstance);
			if (param!==null){
				if (sp["onSetParam"]){
					sp["onSetParam"](param);
				}
		...
		__proto.showPage=function(clz,param,closeOthers,isInstance){
			(closeOthers===void 0)&& (closeOthers=true);
			(isInstance===void 0)&& (isInstance=true);
			var sp;
			sp=this.getItem(clz,isInstance);
	...
	*/
	...
	var ActorData=(function(){
		...
		__proto.getAction=function(){
			if (this.tooHighCount >=6&&this.getIsRandomOK()){
				this.tooHighCount=0;
	...
	*/
	...
	//class ui.actorgame.QuestionSelectItemUI extends laya.ui.View
	var QuestionSelectItemUI=(function(_super){
		function QuestionSelectItemUI(){
			this.actionBtn=null;
			QuestionSelectItemUI.__super.call(this);
		}

		__class(QuestionSelectItemUI,'ui.actorgame.QuestionSelectItemUI',_super);
		var __proto=QuestionSelectItemUI.prototype;
		__proto.createChildren=function(){
			laya.ui.Component.prototype.createChildren.call(this);
	...
	//class ui.actorgame.ReportItemUI extends laya.ui.View
	var ReportItemUI=(function(_super){
		function ReportItemUI(){
			this.icon=null;
			this.changeTxt=null;
			this.starList=null;
			this.nameTxt=null;
		...
		__class(ReportItemUI,'ui.actorgame.ReportItemUI',_super);
		var __proto=ReportItemUI.prototype;
		__proto.createChildren=function(){
	...
	//class ui.actorgame.StarItemUI extends laya.ui.View
	var StarItemUI=(function(_super){
		function StarItemUI(){
			this.icon=null;
			StarItemUI.__super.call(this);
		}

		__class(StarItemUI,'ui.actorgame.StarItemUI',_super);
		var __proto=StarItemUI.prototype;
		__proto.createChildren=function(){
			laya.ui.Component.prototype.createChildren.call(this);
			this.createView(StarItemUI.uiView);
		}

		StarItemUI.uiView={"type":"View","props":{"width":28,"height":28},"child":[{"type":"Image","props":{"var":"icon","skin":"comp/prop.png"}}]};
		return StarItemUI;
	})(View)
	...
	*/
	...
	//class ui.actorgame.QuestionPageUI extends laya.ui.Dialog
	var QuestionPageUI=(function(_super){
		function QuestionPageUI(){
			this.questionTxt=null;
			this.selectList=null;
			QuestionPageUI.__super.call(this);
		}

		__class(QuestionPageUI,'ui.actorgame.QuestionPageUI',_super);
		var __proto=QuestionPageUI.prototype;
		__proto.createChildren=function(){
	...
	*@author ww
	*/
	//class view.actorgame.ActorItem extends ui.actorgame.ActorItemUI
	var ActorItem=(function(_super){
		function ActorItem(){
			this._dataO=null;
			ActorItem.__super.call(this);
			this.icon.on("click",this,this.onClick);
		}

		__class(ActorItem,'view.actorgame.ActorItem',_super);
	...
	//class ui.actorgame.ReportPageUI extends laya.ui.Dialog
	var ReportPageUI=(function(_super){
		function ReportPageUI(){
			this.titleTxt=null;
			this.infoTxt=null;
			this.reportList=null;
			this.continueBtn=null;
			ReportPageUI.__super.call(this);
		}

		__class(ReportPageUI,'ui.actorgame.ReportPageUI',_super);
		var __proto=ReportPageUI.prototype;
		__proto.createChildren=function(){
	...
	*@author ww
	*/
	//class view.actorgame.QuestionSelectItem extends ui.actorgame.QuestionSelectItemUI
	var QuestionSelectItem=(function(_super){
		function QuestionSelectItem(){
			this._dataO=null;
			QuestionSelectItem.__super.call(this);
			this.actionBtn.on("click",this,this.onClick);
		}

		__class(QuestionSelectItem,'view.actorgame.QuestionSelectItem',_super);
	...
	*@author ww
	*/
	//class view.actorgame.ReportItem extends ui.actorgame.ReportItemUI
	...
	*@author ww
	*/
	//class view.actorgame.StarItem extends ui.actorgame.StarItemUI
	var StarItem=(function(_super){
		function StarItem(){
			this._dataO=null;
			StarItem.__super.call(this);
		}

		__class(StarItem,'view.actorgame.StarItem',_super);
	...
	*@author ww
	*/
	//class view.actorgame.QuestionPage extends ui.actorgame.QuestionPageUI
	var QuestionPage=(function(_super){
		function QuestionPage(){
			QuestionPage.__super.call(this);
			this.selectList.renderHandler=new Handler(this,this.itemRender);
		}
		...
		__getset(1,QuestionPage,'I',function(){
			if (!QuestionPage._I)QuestionPage._I=new QuestionPage();
			return QuestionPage._I;
		},ui.actorgame.QuestionPageUI._$SET_I);

		QuestionPage._I=null
		return QuestionPage;
	})(QuestionPageUI)
	...
	*/
	...
	var ReportPage=(function(_super){
		...
		__getset(1,ReportPage,'I',function(){
			if (!ReportPage._I)ReportPage._I=new ReportPage();
			return ReportPage._I;
		},ui.actorgame.ReportPageUI._$SET_I);
	...
	Laya.__init([LoaderManager,EventDispatcher,LocalStorage,Render,Browser,Timer,View,GraphicAnimation]);
	new Game();
