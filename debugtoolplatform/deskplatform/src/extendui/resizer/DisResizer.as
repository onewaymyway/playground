package laya.ide.managers.resizer 
{
	...
	public class DisResizer 
	{
		...
		public static function init():void
		{
			...
			_up.height = barWidth;
			_up.type = LayoutRecManager.Horizon;
			
			_down=new AutoFillRec("T");
			_down.height = barWidth;
			_down.type = LayoutRecManager.Horizon;
			
			_left=new AutoFillRec("R");
			_left.width = barWidth;
			_left.type = LayoutRecManager.Vertical;
			
			_right=new AutoFillRec("R");
			_right.width = barWidth;
			_right.type = LayoutRecManager.Vertical;
		...
		private static function barDown(e:Event):void
		{
			...
			var area:Rectangle;
			area = new Rectangle();
			if (tBar.type == LayoutRecManager.Horizon)
			{
				area.x = tBar.x;
				area.width = 0;
				area.y = tBar.y - 200;
