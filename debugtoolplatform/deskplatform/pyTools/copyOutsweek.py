...
compileParam=getAbsPath("../DeskPlatform.as3proj")+";iflash=false;chromerun=false;outlaya=true";
#sOpen(compileExe,compileParam);
os.system(compileExe+" "+compileParam)
print("compile complete");
copyFileToTar(getAbsPath("../bin/h5"),getAbsPath("../../ElectronApp/DeskPlatform/main/"))
print("copy complete")
