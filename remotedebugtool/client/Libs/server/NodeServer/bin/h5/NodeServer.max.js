...
(function(window,document,Laya){
	...
	*/
	...
	var WSClient=(function(){
		...
		__proto.sendToChannel=function(data,but){
			this.serverO.sendToChannel(JSON.stringify(data),this.channel,but);
		}
	...
	*/
	...
	var WSServer=(function(){
		...
		__proto.removeFromChannel=function(client){
			var channelKey;
			channelKey=client.channel;
			var channel;
			channel=this.channelDic[channelKey];
			if (!channel)return;
			var i=0,len=0;
			len=channel.length;
			for (i=0;i < len;i++){
		...
		__proto.addToChannel=function(client){
			var channel;
			if (!this.channelDic[client.channel]){
				this.channelDic[client.channel]=[];
			}
			channel=this.channelDic[client.channel];
			if (channel.indexOf(client)< 0){
				channel.push(client);
			}
		}

		__proto.sendToChannel=function(data,channelName,but){
			var channel;
			channel=this.channelDic[channelName];
			if (!channel)return;
			var i=0,len=0;
			len=channel.length;
			var tClient;
		...
		__proto.onMessage=function(message){
			...
			switch(data.type){
				...
				case "joinchannel":
					...
					this.mServer.addToChannel(this);
					this.sendJson({type:"joinchannel"});
					break ;
				case "hello":
					this.mServer.addToChannel(this);
...
/*
1 file:///E:/wangwei/codes/laya/libs/LayaAir/plugins/remotedebugtool/client/Libs/server/NodeServer/src/nodetools/devices/FileManager.as (225):warning:XMLElement This variable is not defined.
2 file:///E:/wangwei/codes/laya/libs/LayaAir/plugins/remotedebugtool/client/Libs/server/NodeServer/src/nodetools/devices/FileManager.as (237):warning:XMLElement This variable is not defined.
3 file:///E:/wangwei/codes/laya/libs/LayaAir/plugins/remotedebugtool/client/Libs/server/NodeServer/src/nodetools/devices/FileTools.as (82):warning:Browser.window.location.href This variable is not defined.
4 file:///E:/wangwei/codes/laya/libs/LayaAir/plugins/remotedebugtool/client/Libs/server/NodeServer/src/nodetools/devices/FileTools.as (82):warning:Browser.window.location.href This variable is not defined.
5 file:///E:/wangwei/codes/laya/libs/LayaAir/plugins/remotedebugtool/client/Libs/server/NodeServer/src/nodetools/devices/FileTools.as (642):warning:Alert.show This variable is not defined.
*/