...
(function(window,document,Laya){
	...
	*/
	...
	var TestSocket=(function(){
		function TestSocket(){
			...
			Laya.init(1000,900);
			this.testDebugClient();
			Laya.loader.load("res/atlas/comp.atlas",new Handler(this,this.initTestPage));
		}
	...
	*@author ww
	*/
	//class remotedebugtool.client.DebugClient
	var DebugClient=(function(){
		...
		__class(DebugClient,'remotedebugtool.client.DebugClient');
		...
		RemoteWorkUtils.getAllTargetView=function(){
			...
			function workChild (child){
				if (child["__$fileRefer"]){
					viewList.push([child["__$fileRefer"],child.$_GID]);
				}
			}
			RemoteWorkUtils.walkTargetEX(Laya.stage,workChild,null,null);
			return viewList;
