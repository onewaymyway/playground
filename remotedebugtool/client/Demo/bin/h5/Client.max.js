...
(function(window,document,Laya){
	...
	*@author ww
	*/
	//class TestChromeSocket
	var TestChromeSocket=(function(){
		function TestChromeSocket(){
			Laya.init(1000,900);
			this.test();
		}

		__class(TestChromeSocket,'TestChromeSocket');
		var __proto=TestChromeSocket.prototype;
		__proto.test=function(){
			Laya.stage.on("click",this,this.checkingDebugTarget);
		}
