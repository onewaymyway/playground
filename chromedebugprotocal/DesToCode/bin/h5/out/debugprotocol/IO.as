package debugprotocol.IO 
{
	...
	public class IO 
	{
		...
		public static const DependDomains:Array=[];
  		 ...
  		 * @return 
  		 */
  		public static const close:String = "IO.close";
  	...
  	following the last read). Some types of streams may only support sequential reads.
  		 ...
  		 */
  		public static const read:String = "IO.read";
  		 ...
  		 */
  		public static const resolveBlob:String = "IO.resolveBlob";
	}
