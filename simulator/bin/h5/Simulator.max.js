...
(function(window,document,Laya){
	...
	*/
	...
	//class ui.simulator.ActionItemUI extends laya.ui.View
	var ActionItemUI=(function(_super){
		function ActionItemUI(){
			this.actionText=null;
			this.actionBtn=null;
			ActionItemUI.__super.call(this);
		}
	...
	//class ui.simulator.ActionListUI extends laya.ui.View
	var ActionListUI=(function(_super){
		function ActionListUI(){
			this.list=null;
			ActionListUI.__super.call(this);
		}

		__class(ActionListUI,'ui.simulator.ActionListUI',_super);
		var __proto=ActionListUI.prototype;
		__proto.createChildren=function(){
	...
	//class ui.simulator.ItemListItemUI extends laya.ui.View
	var ItemListItemUI=(function(_super){
		...
		__class(ItemListItemUI,'ui.simulator.ItemListItemUI',_super);
		...
		ItemListItemUI.uiView={"type":"View","props":{"width":102,"height":18},"child":[{"type":"Label","props":{"y":0,"x":0,"width":102,"var":"itemText","text":"label","styleSkin":"comp/label.png","height":18,"color":"#2e92ef"}}]};
		return ItemListItemUI;
	})(View)


	//class ui.simulator.ItemListUI extends laya.ui.View
	var ItemListUI=(function(_super){
		function ItemListUI(){
			this.list=null;
			ItemListUI.__super.call(this);
		}

		__class(ItemListUI,'ui.simulator.ItemListUI',_super);
		var __proto=ItemListUI.prototype;
		__proto.createChildren=function(){
	...
	//class ui.simulator.PlayMainViewUI extends laya.ui.View
	var PlayMainViewUI=(function(_super){
		function PlayMainViewUI(){
			this.itemList=null;
			this.actionList=null;
			PlayMainViewUI.__super.call(this);
		}

		__class(PlayMainViewUI,'ui.simulator.PlayMainViewUI',_super);
		var __proto=PlayMainViewUI.prototype;
		__proto.createChildren=function(){
	...
	*/
	...
	var ActionList=(function(_super){
		...
		__class(ActionList,'view.actionlist.ActionList',_super);
		var __proto=ActionList.prototype;
		__proto.setData=function(dataList){
	...
	*@author ww
	*/
	//class view.PlayMainView extends ui.simulator.PlayMainViewUI
	var PlayMainView=(function(_super){
		...
		__class(PlayMainView,'view.PlayMainView',_super);
		var __proto=PlayMainView.prototype;
		__proto.test=function(){
			console.log("hello Simulator");
			this.drowningMachine=new DrowningMachine();
			this.drowningMachine.initByRules("data/rules.json",new Handler(this,this.initDrowningMachine));
		...
		__proto.freshUI=function(){
			...
			this.itemList.setData(this.drowningMachine.getItemList());
		}
	...
	*/
	...
	var ItemList=(function(_super){
		function ItemList(){
			ItemList.__super.call(this);
			this.initList();
		}

		__class(ItemList,'view.itemlist.ItemList',_super);
		var __proto=ItemList.prototype;
		__proto.setData=function(dataList){
			this.list.array=dataList;
		}
	...
	Laya.__init([EventDispatcher,LoaderManager,LocalStorage,Render,Browser,View,Timer,GraphicAnimation]);
	new Game();
